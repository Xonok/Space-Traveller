...
def do_structure_permission_change(cname,pship,permission="str",value="str"):
	psystem,px,py = pship.loc()
	tstructure = structure.get(psystem,px,py)
	if not tstructure: raise error.Page()
	if cname != tstructure["owner"]:
		raise error.User("Can't change permissions unless you're the owner.")
	tstructure.change_permission(permission,value)
api.register("gather",gather,"tile","map-characters")
api.register("mine",mine,"tile","map-characters")
api.register("investigate",investigate)
api.register("excavate",excavate)
api.register("drop",drop,"tile","map-characters")
...
api.register("take-loot",take_loot,"tile","map-characters")
api.register("pack-station",pack_station,"tile","tiles","map-structure","map-characters")
api.register("get-goods",do_get_goods,"structure","prices","bp-info","repair-fees","industry-defs","transport-targets","tile","local-quests","character-quests","skill-location","skill-data","group")
api.register("structure-trade",do_structure_trade,"structure","local-quests","character-quests")
...
api.register("structure-permission-change",do_structure_permission_change,"structure")
